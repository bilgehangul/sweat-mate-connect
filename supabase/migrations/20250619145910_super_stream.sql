/*
  # User Availability and Reviews Schema Update

  1. New Tables
    - `user_availability` - Store user workout availability schedules
    - `workout_reviews` - Store reviews between workout partners
