              ...
              <div className="text-center lg:text-left space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  ...
                  <Button 
                    variant="outline"
                    size="lg"
                    className="text-xl px-8 py-6 border-2 border-white text-white hover:bg-white hover:text-energy-orange transition-all duration-300 font-bold rounded-full backdrop-blur-sm"
